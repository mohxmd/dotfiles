return {
  ...
  config = function()
    ...
    elseif codelldb ~= "" then
      ...
      -- Keep startup quiet when the optional adapter is not installed.
      -- The configurations remain available as soon as lldb-dap or
      -- codelldb is added to PATH.
      vim.g.config_dap_adapter_missing = true
    end
